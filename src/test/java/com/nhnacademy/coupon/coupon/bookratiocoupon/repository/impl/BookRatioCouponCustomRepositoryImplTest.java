...
@DataJpaTest
@Import(BookRatioCouponCustomRepositoryImpl.class)
class BookRatioCouponCustomRepositoryImplTest {
    ...
    void setUp() {
        ...
        BookRatioCoupon bookRatioCoupon = new BookRatioCoupon(bookCoupon, 0.2, 200L);
        entityManager.persist(bookRatioCoupon);
    ...
    @Test
    void testFindBookRatioCoupon() {
        Long couponFormId = 1L; // This should match the ID of the inserted CouponForm
        Optional<Tuple> result = bookRatioCouponCustomRepository.findBookRatioCoupon(couponFormId);
